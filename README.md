...
- **MultiScreen Apps** - The more screens we have, the more possibilities you discover. Learn switching among different screens, activities, and fragments. 
- **Networking** - There are a lot of APIs available all over the internet, with the help of them we can build apps with dynamic content. Learn about HTTP requests, JSON Parsing, and threads.

## 1. Gmail Clone 
Flutter App under 5KB for Flutter Submission

* Can you believe that an app can be made under 5 Kilobytes?
* But it's a UI clone and it was a successful submission btw Flutter was a lot of fun to work with. 

<img src="https://github.com/AbhiramReddyD/Android-App-Projects/blob/master/images/flutter.PNG" height="400" width="230"><img src="https://github.com/AbhiramReddyD/Android-App-Projects/blob/master/images/cert.png" height="275" width="360">

## 2. Instagram Clone
UI Clone with Koltin

* I enjoyed coding in Kotlin after Java, 
* Less boilerplate and errors make building apps with Kotlin much easier. 
...
* Project Description: An app with two Activities and a Recycler View
* Thoughts: I made an app to show posts from a blog or page and display them as cards, here it shows posts from my old WordPress blog.
...
* Project Description: A news app to gather live news.
...
Portfolio App | Score Board App | Calculator App
