...
- **Networking** - There are a lot of API-s available all over the internet, with the help of them we can build apps with dynamic content. Learn about HTTP requests, JSON Parsing and threads.

## 1. Gmail Clone 
\- Flutter App under 5KB for Flutter Submission
* Can you believe that an app can be made under 5 Kilobytes ?
* But it's a UI clone and it was successful submission btw Flutter was a lot of fun to work with. 
...
* I ejoyed coding in Kotlin after Java, 
* Less boiler-plate and errors makes building apps with Kotlin much easier. 
...
* Thoughts: I made an app to shows posts from a blog or page and display them as cards, here it shows posts from my old wordpress blog.
